...
export default function Sidebar({ notes, activeNoteId, onSelectNote, isOpen }) {
  ...
  return (
    <div className="fixed md:static inset-y-[3.5rem] left-0 z-40 w-64 md:w-80 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border-r border-slate-200/80 dark:border-slate-700/80 flex flex-col h-[calc(100vh-3.5rem)]">
