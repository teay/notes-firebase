      ...
      <div className="p-4 border-b border-slate-100">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm bg-slate-100/80 rounded-xl border-0 outline-none focus:bg-white focus:ring-2 focus:ring-amber-300/50 transition-all placeholder:text-slate-400"
          />
          {search && (
            <button
              onClick={() => setSearch('')}
